            ...
            <View style={{ padding: 16 }}>
              ...
              {isHost && (
                <View style={{
                  ...
                  <Text style={{ fontSize: 14, fontWeight: '600', color: '#7f8c8d', marginBottom: 8 }}>
                  ...
                  <View style={{ flexDirection: 'row', marginBottom: 16 }}>
                    {[1, 2, 3, 4].map(n => (
                      <TouchableOpacity
                        ...
                        onPress={() => setCards(n)}
                        style={{
                          backgroundColor: state.cardsPerPlayer === n ? '#e74c3c' : '#ecf0f1',
                          paddingVertical: 8,
                      ...
                      >
                        <Text style={{
                          color: state.cardsPerPlayer === n ? 'white' : '#7f8c8d',
                          fontWeight: '600'
                        }}>
                          {n}
                        </Text>
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 18, fontWeight: '700', color: '#2c3e50', marginBottom: 16 }}>
