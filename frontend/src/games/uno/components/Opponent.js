      ...
      style={[
        ...
        isMe &&
          ...
          responsiveSize.avatarSize > 45 && {
            marginTop: 20, // Margen superior adicional para mi jugador en pantallas de alta densidad (scale ~1.34)
          },
      ]}
    >
...
const styles = StyleSheet.create({
  ...
  myPlayerContainer: {
    borderColor: "rgba(46, 204, 113, 0.3)", // Borde verde sutil
  },
  ...
  activePlayerContainer: {
    backgroundColor: "rgba(52, 152, 219, 0.2)", // Fondo azul sutil cuando es el turno del jugador
